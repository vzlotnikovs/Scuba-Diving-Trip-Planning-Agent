...
SYSTEM_PROMPT: str = (
    ...
    "4. Research: Use the `search_tavily` tool to find relevant information and potential scuba diving sites based on the trip details.\n"
    "5. Draft an itinerary: The itinerary MUST include scuba diving site NAMES. It should also include marine life or other highlights of the sites. Use bullet points. Hard limit: output must be no more than 400 words.\n"
